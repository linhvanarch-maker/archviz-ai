...
export function Toolbar({ onOpenPromptModal }: Props) {
  ...
  return (
    <div className="toolbar">
      <span className="toolbar-wordmark">
        ArchViz <span style={{ color: "var(--accent)" }}>AI</span>
      </span>
      ...
      <div className="toolbar-actions">
        {/* Paste Prompt shortcut */}
        {onOpenPromptModal && (
          <button
            className="toolbar-paste-btn"
            onClick={onOpenPromptModal}
            title="Dán prompt thủ công (tạo node render mới)"
          >
